using System;
using System.Text;
using BSL.v58.TitanEngine.DataS.ChecksumLogic;
using BSL.v58.TitanEngine.DataS.HelpsLogic;

namespace BSL.v58.TitanEngine.DataS;
...
public class ByteStream : ChecksumEncoder
{
    ...
    public void ohd()
    {
        byte[] dump = File.ReadAllBytes("../BSL.v58.TitanEngine/DataS/ohd.bin");
        _buffer = dump;
        _offset += dump.Length;
    }
