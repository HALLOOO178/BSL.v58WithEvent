using BSL.v58.TitanEngine.DataS.HelpsLogic;

namespace BSL.v58.Logic.Protocol.Laser.S;
...
public class OwnHomeDataMessage : PiranhaMessage
{
    public override void Encode()
    {
        ...
        ByteStreamHelper.WriteDataReference(ByteStream, 28, 626);
        ...
        {
            ByteStreamHelper.WriteDataReference(ByteStream, 16, 87);
        }

        ByteStream.WriteString("RU");
        ByteStream.WriteString("BSL.v58");
        ...
        {
            ByteStream.WriteVInt(-1);
            ByteStream.WriteVInt(36);
            ByteStream.WriteVInt(0);
            ByteStream.WriteVInt(0);
            ByteStream.WriteVInt(0);
            ByteStream.WriteVInt(0); // Tokens
            ...
            ByteStream.WriteVInt(-1);
            ByteStream.WriteBoolean(true);
            ByteStream.WriteString("51bedbef4ca4b3d8595a9027ccda03c9e9248c37");
            ByteStream.WriteString("/67a430fd-f323-4883-a228-849cf1913533_collab_demons.sc");
            ByteStream.WriteBoolean(false);
            ByteStream.WriteVInt(-1);
            ByteStream.WriteVInt(-1);
            ByteStream.WriteVInt(-1);
        ...
        ByteStream.WriteVInt(21);
        {
            ...
            ByteStream.WriteVLong(new LogicLong(41000000 + 112, 1));
        ...
        ByteStream.WriteVInt(2);
        {
            ByteStreamHelper.WriteDataReference(ByteStream, 16, 86);
            ByteStream.WriteVInt(925);
            ByteStream.WriteVInt(169);
            ByteStream.WriteVInt(0);
            ByteStream.WriteVInt(0);
            ByteStream.WriteVInt(0);
            ByteStream.WriteVInt(0);
        ...
        ByteStream.WriteBoolean(false);
        ByteStream.WriteBoolean(true);
        ByteStream.WriteVInt(2); // Should show side choosing animation/free will menu
        ByteStream.WriteVInt(999999); // Seconds until side change
        ByteStream.WriteBoolean(true);
        ByteStream.WriteVInt(0); // Demon cards to reveal
        ByteStream.WriteVInt(0);
        ByteStream.WriteVInt(0);
        ByteStream.WriteVInt(0);
        ByteStream.WriteVInt(0); // Array
        ByteStream.WriteVInt(69); // Angel drops count
        ByteStream.WriteVInt(1); // Array
        {
            ByteStream.WriteVInt(1);
        }
        ByteStream.WriteVInt(14466);
        ByteStream.WriteVInt(0);
        ByteStream.WriteVInt(0); // Angel cards to reveal
        ByteStream.WriteVInt(69); // Demon drops count
        ByteStream.WriteVInt(1); // Event slots with krusty kash
        ByteStream.WriteVInt(4);
        ByteStream.WriteVInt(112);
        ByteStream.WriteVInt(4);
        ByteStream.WriteVInt(2);
        ByteStream.WriteVInt(1); // Array
        {
